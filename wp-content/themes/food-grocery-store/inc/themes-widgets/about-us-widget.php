...
class Food_Grocery_Store_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Food_Grocery_Store_About_Widget',
			__('VW About us', 'food-grocery-store'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'food-grocery-store' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','food-grocery-store'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','food-grocery-store'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','food-grocery-store'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','food-grocery-store'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','food-grocery-store'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','food-grocery-store'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function food_grocery_store_about_custom_load_widget() {
	register_widget( 'Food_Grocery_Store_About_Widget' );
}
add_action( 'widgets_init', 'food_grocery_store_about_custom_load_widget' );