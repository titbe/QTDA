...
function food_grocery_store_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'food-grocery-store') {
		wp_redirect(admin_url('themes.php?page=food_grocery_store_guide'));
	}
}
endif;
